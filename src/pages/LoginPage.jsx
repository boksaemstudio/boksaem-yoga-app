  ...
  return <div style={{
    ...
    padding: '20px'
      ...
      textAlign: 'center'
        ...
        marginBottom: '4vh'
          ...
          letterSpacing: '-0.02em'
                    ...
                    {typeof window !== 'undefined' && window.location.hostname.includes('passflow') ? t('loginTitle') && t('loginTitle') !== 'loginTitle' ? t('loginTitle') : config.IDENTITY?.SLOGAN || '' : config.IDENTITY?.SLOGAN || ''}
                </h1>
        ...
        gap: '18px'
          ...
          textAlign: 'left'
            ...
            display: 'block'
                        ...
                        <input type="email" placeholder="example@test.com" value={email} onChange={e => setEmail(e.target.value)} style={{
            width: '100%',
            padding: '14px',
            borderRadius: '12px',
      ...
      paddingBottom: '20px'
                ...
                <a href="http://pf.kakao.com/_zDxiMX/chat" target="_blank" rel="noopener noreferrer" style={{
        display: 'inline-flex',
        alignItems: 'center',
        justifyContent: 'center',
        ...
        wordBreak: 'keep-all'
                    ...
                    <p style={{
          margin: '0'
        }}>Company: PassFlow AI | CEO: Boksoon Kim</p>
                    <p style={{
          margin: '0'
        }}>Business Reg No: 789-66-00676</p>
                    <p style={{
          margin: '0'
        }}>Address: 201, 81 Seogang-ro 1-gil, Mapo-gu, Seoul, Republic of Korea</p>
                    <p style={{
          margin: '8px 0 0 0',
          color: 'rgba(255,255,255,0.2)'
        }}>© {new Date().getFullYear()} PassFlow AI. All rights reserved.</p>
                </div>
            </div>
        </div>;
};
