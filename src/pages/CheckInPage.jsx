    ...
    return (
        <div className="checkin-wrapper" style={{
            ...
            <div className="checkin-content" style={{
                ...
                padding: 'clamp(20px, 3vh, 50px) clamp(20px, 3vw, 40px) clamp(35px, 5vh, 60px)', /* 하단 여백 최소 35px 확보 */
                width: '100%',
                margin: '0 auto',
                alignItems: 'stretch',
                overflow: 'hidden'
                        ...
                        >
                            ...
                            <div className="qr-text" style={{
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 'clamp(2px, 0.5vh, 5px)' }}>
                                    <li style={{ fontSize: 'clamp(1.0rem, 2vh, 1.2rem)', color: 'rgba(255, 255, 255, 0.95)', display: 'flex', alignItems: 'center', gap: '8px', lineHeight: 1.1 }}>
                                        ✓ 잔여 횟수 확인
                                    </li>
                                    <li style={{ fontSize: 'clamp(1.0rem, 2vh, 1.2rem)', color: 'rgba(255, 255, 255, 0.95)', display: 'flex', alignItems: 'center', gap: '8px', lineHeight: 1.1 }}>
                                        ✓ 수업 일정 보기
