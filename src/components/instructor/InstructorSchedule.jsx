...
const InstructorSchedule = ({
  ...
  const renderCalendar = () => {
    ...
    for (let d = 1; d <= daysInMonth; d++) {
      ...
      const holidayMap = {
        'holiday_new_year': t("g_15b744") || "신정",
        'holiday_lunar_new_year': t("g_b5031f") || "설날",
        'holiday_samiljeol': t("g_8e793b") || "삼일절",
        'holiday_childrens_day': t("g_f14f6c") || "어린이날",
        'holiday_buddha': t("g_e0f35e") || "석가탄신일",
        'holiday_memorial': t("g_bc3790") || "현충일",
        'holiday_liberation': t("g_e2084c") || "광복절",
        'holiday_chuseok': t("g_60387c") || "추석",
        'holiday_foundation': t("g_a32af9") || "개천절",
        'holiday_hangul': t("g_cb4424") || "한글날",
        'holiday_christmas': t("g_7a78ee") || "크리스마스",
        'holiday_election': t("g_0b2766") || "선거일",
        'holiday_arbor_day': t("g_b3854d") || "식목일"
      };
          ...
          return <div key={idx} onClick={() => {
            ...
            ...(expandedClassKey === `${cls.time}_${cls.title}` ? {
              ...
              borderTop: '1px solid rgba(255,255,255,0.1)'
                ...
                marginBottom: '8px',
                fontWeight: 'bold'
              }}>{t("g_f1a05a") || "👥 출석 명단"}</div>
                                                {loadingAttendance ? <div style={{
                fontSize: '0.8rem',
                color: 'var(--text-secondary)'
              }}>{t("g_fcad99") || "조회 중..."}</div> : <div style={{
                display: 'flex',
                flexDirection: 'column',
                gap: '4px'
              }}>
