    ...
    return <div style={{
      ...
      paddingBottom: '12px'
        ...
        minWidth: '800px'
                    ...
                    {[t("g_95e431") || "\uC77C", t("g_5b51dd") || "\uC6D4", t("g_74d3f7") || "\uD654", t("g_cae82d") || "\uC218", t("g_d5f699") || "\uBAA9", t("g_cef92d") || "\uAE08", t("g_ccc0dc") || "\uD1A0"].map(d => <div key={d} style={{
          textAlign: 'center',
          fontWeight: 'bold',
          padding: '8px',
          color: 'var(--text-secondary)'
                    ...
                    ...(isCancelled && {
                      ...
                      return <span style={{
                        ...
                        display: 'block'
                                                                ...
                                                                📋 {bookedCount}/{capacity}{t("g_7b3c6e") || "\uBA85"}</span>;
                    })()}
                                                </div>;
                })}
                                    </div>
  ...
  const renderUndefinedView = () => <div style={{
    padding: '0px'
      ...
      textAlign: 'center'
          ...
          color: '#60A5FA',
          margin: '0 0 8px 0'
        }}>{year}{t("g_e29d2c") || "\uB144"}{month}{t("g_82a9c5") || "\uC6D4 \uC77C\uC815\uC774 \uBE44\uC5B4 \uC788\uC2B5\uB2C8\uB2E4."}</h3>
                    <p style={{
          color: 'var(--text-secondary)',
          margin: 0,
          fontSize: '0.95rem'
        }}>{t("g_615bd7") || "\uC77C\uC77C\uC774 \uB4F1\uB85D\uD560 \uD544\uC694 \uC5C6\uC774, \uC9C0\uB09C \uB2EC \uC77C\uC815\uC744 \uADF8\uB300\uB85C \uBCF5\uC0AC\uD574\uC11C \uD3B8\uD558\uAC8C \uC2DC\uC791\uD558\uC138\uC694."}</p>
                </div>
        ...
        transition: 'all 0.2s'
      }}>{t("g_db0ba7") || "\uD83D\uDCE5 \uC9C0\uB09C\uB2EC \uC2A4\uCF00\uC904 \uADF8\uB300\uB85C \uBCF5\uC0AC\uD558\uAE30"}</button>
            </div>
            {renderCalendar()}
        </div>;
    ...
    borderRadius: '12px'
      ...
      gap: '10px'
        ...
        gap: '10px'
                    ...
                    <button onClick={handlePrevMonth} className="nav-btn-circle" aria-label={t("g_0834d5") || "\uC774\uC804 \uC6D4"}><CaretLeft /></button>
                    <h2 style={{
          margin: 0,
          fontSize: '1.5rem',
          display: 'flex',
          ...
          gap: '10px'
                        ...
                        {year}{t("g_e29d2c") || "\uB144"}{month}{t("g_5b51dd") || "\uC6D4"}{scheduleStatus === 'saved' ? <span style={{
            fontSize: '0.8rem',
            padding: '4px 10px',
            borderRadius: '20px',
            backgroundColor: '#10B981',
            color: 'white'
          }}>{t("g_bea14e") || "\uD655\uC815\uB428"}</span> : <span style={{
            fontSize: '0.8rem',
            padding: '4px 10px',
            borderRadius: '20px',
            ...
            color: 'white'
                    ...
                    <button onClick={handleNextMonth} className="nav-btn-circle" aria-label={t("g_abc273") || "\uB2E4\uC74C \uC6D4"}><CaretRight /></button>
                </div>
                <div style={{
        display: 'flex',
        gap: '10px',
      ...
      textAlign: 'center',
      padding: '40px'
    }}>{t("g_1c8c88") || "\uB370\uC774\uD130 \uCC98\uB9AC \uC911..."}</div> : scheduleStatus === 'saved' ? renderCalendar() : renderUndefinedView()}

            {/* ── 수업 편집 모달 ── */}
            {showEditModal && <div className="modal-overlay" role="dialog" aria-modal="true" aria-label={t("g_7b690b") || "\uC218\uC5C5 \uAD00\uB9AC"}>
          ...
          marginBottom: '20px'
                            ...
                            <h3 style={{
            margin: 0
          }}>{selectedDate}{t("g_7b690b") || "\uC218\uC5C5 \uAD00\uB9AC"}</h3>
          ...
          paddingRight: '10px'
            ...
            time: '10:00',
            title: classTypes[0] || t("g_774943") || "\uC218\uC5C5",
            ...
            color: 'var(--text-secondary)'
                                ...
                                <Plus size={18} />{t("g_697f2c") || "\uC218\uC5C5 \uCD94\uAC00"}</button>
                        </div>
                        <div style={{
          display: 'flex',
          gap: '10px',
          ...
          }}>{t("g_a3b35f") || "\uD83D\uDCC5 \uC774 \uB2EC\uC758 \uBAA8\uB4E0"}{new Date(selectedDate).toLocaleString('ko-KR', {
              weekday: 'short'
            })}{t("g_becd85") || "\uC694\uC77C \uC218\uC815"}</button>
                            <button onClick={() => handleSave(false)} className="action-btn-gold">{t("g_9d0a47") || "\uC800\uC7A5"}</button>
                        </div>
                    </div>
                </div>}

            {/* ── 초기화 확인 모달 ── */}
            {showResetConfirm && <div className="modal-overlay" role="dialog" aria-modal="true" aria-label={t("g_5c95b4") || "\uC2A4\uCF00\uC904 \uCD08\uAE30\uD654 \uD655\uC778"}>
        ...
        textAlign: 'center'
          ...
          margin: '0 0 16px 0',
          fontSize: '1.3rem'
        }}>{t("g_3d3730") || "\uC2A4\uCF00\uC904 \uCD08\uAE30\uD654"}</h3>
                        <p style={{
          color: 'var(--text-secondary)',
          marginBottom: '24px',
          lineHeight: '1.5'
        }}>{t("g_1c07ed") || "\uC815\uB9D0\uB85C"}{year}{t("g_e29d2c") || "\uB144"}{month}{t("g_362e45") || "\uC6D4 \uC2A4\uCF00\uC904\uC744 \uCD08\uAE30\uD654\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?"}<br /><br />{t("g_283180") || "\uBAA8\uB4E0 \uC218\uC5C5 \uB370\uC774\uD130\uAC00 \uC0AD\uC81C\uB418\uBA70, \uC0C1\uD0DC\uAC00 [\uBBF8\uC815]\uC73C\uB85C \uB3CC\uC544\uAC11\uB2C8\uB2E4."}<br />
                            <span style={{
            fontSize: '0.85rem',
            color: '#6366F1',
            marginTop: '8px',
            display: 'block'
          }}>{t("g_6b09d2") || "(\uCD08\uAE30\uD654 \uC9C1\uC804 \uC0C1\uD0DC\uB294 \uC784\uC2DC \uBC31\uC5C5\uB429\uB2C8\uB2E4)"}</span>
                        </p>
                        <div style={{
          display: 'flex',
          gap: '12px',
          justifyContent: 'center'
            ...
            backgroundColor: '#EF4444',
            flex: 1
          }}>{t("g_59a7dd") || "\uB124, \uCD08\uAE30\uD654\uD569\uB2C8\uB2E4"}</button>
                        </div>
                    </div>
                </div>}

            {/* ── 백업 복원 모달 ── */}
            {showRestoreModal && <div className="modal-overlay" role="dialog" aria-modal="true" aria-label={t("g_b74b9f") || "\uBC31\uC5C5 \uBCF5\uC6D0"}>
                    <div className="modal-content" style={{
        maxWidth: '500px'
      }}>
                        <div style={{
          ...
          marginBottom: '20px'
            ...
            gap: '8px'
                                ...
                                <ClockCounterClockwise size={24} color="#6366F1" />{t("g_842c36") || "\uBC31\uC5C5\uC5D0\uC11C \uBCF5\uC6D0\uD558\uAE30"}</h3>
          ...
          marginBottom: '16px',
          fontSize: '0.9rem'
        }}>{t("g_52165d") || "\uC2A4\uCF00\uC904\uC744 \uCD08\uAE30\uD654\uD560 \uB54C\uB9C8\uB2E4 \uAC00\uC7A5 \uCD5C\uADFC 2\uAC1C\uC758 \uC2A4\uCF00\uC904\uC774 \uC790\uB3D9\uC73C\uB85C \uBC31\uC5C5\uB429\uB2C8\uB2E4. \uC774\uC804 \uC0C1\uD0DC\uB85C \uB418\uB3CC\uB9AC\uB824\uBA74 \uC544\uB798 \uBAA9\uB85D\uC5D0\uC11C \uC120\uD0DD\uD558\uC138\uC694."}</p>
                        <div style={{
          display: 'flex',
          flexDirection: 'column',
          gap: '10px',
          ...
          overflowY: 'auto'
            ...
            borderRadius: '8px',
            color: 'var(--text-secondary)'
          }}>{t("g_4d3f55") || "\uC0AC\uC6A9 \uAC00\uB2A5\uD55C \uBC31\uC5C5\uC774 \uC5C6\uC2B5\uB2C8\uB2E4."}</div> : backupList.map((backup, idx) => {
            ...
            return <div key={backup.id} style={{
              ...
              border: '1px solid rgba(255,255,255,0.05)'
                  ...
                  marginBottom: '4px'
                    ...
                    hour: '2-digit',
                    minute: '2-digit'
                  })}{t("g_3b5157") || "\uC5D0 \uBC31\uC5C5\uB428"}</div>
                                                <div style={{
                  fontSize: '0.8rem',
                  color: 'var(--text-secondary)'
                }}>{t("g_97dfc6") || "\uCD1D"}{clsCount}{t("g_ebf9da") || "\uAC1C\uC758 \uC218\uC5C5 \uB370\uC774\uD130 \uD3EC\uD568"}{idx === 0 && <span style={{
                    marginLeft: '8px',
                    color: '#10B981',
                    padding: '2px 6px',
                    borderRadius: '4px',
                    backgroundColor: 'rgba(16, 185, 129, 0.1)'
                  }}>{t("g_7008e7") || "\uAC00\uC7A5 \uCD5C\uADFC"}</span>}
                                                </div>
                                            </div>
