...
const dayNamesMap = {
  ko: [t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || "\uC77C", t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || "\uC6D4", t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || "\uD654", t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || "\uC218", t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || "\uBAA9", t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || "\uAE08", t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || "\uD1A0"],
...
const LogsTab = ({
      ...
      try {
        ...
        results.forEach((dayLogs, idx) => {
          ...
          dayLogs.forEach(log => {
            ...
            const cName = info?.className || log.className || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || "\uC77C\uBC18";
            const cInst = info?.instructor || log.instructor || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || "\uC120\uC0DD\uB2D8";
          ...
          rawPlotData.push({
            ...
            count: count,
            dayName: [t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || "\uC77C", t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || "\uC6D4", t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || "\uD654", t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || "\uC218", t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || "\uBAA9", t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || "\uAE08", t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || "\uD1A0"][dayOfWeek]
          });
        });
  ...
  const classCards = (() => {
    ...
    activeLogs.forEach(log => {
      ...
      const canonicalClassName = info?.className || log.className || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || "\uC77C\uBC18";
      const canonicalInstructor = info?.instructor || log.instructor || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || "\uC120\uC0DD\uB2D8";
      const key = canonicalClassName === (t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || "\uC790\uC728\uC218\uB828") ? `${canonicalClassName}-${log.branchId}` : `${canonicalClassName}-${canonicalInstructor}-${log.branchId}-${classTime}`;
      if (!groups[key]) {
        groups[key] = {
          className: canonicalClassName,
          instructor: canonicalClassName === (t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || "\uC790\uC728\uC218\uB828") ? t("g_6745df") || t("g_6745df") || t("g_6745df") || t("g_6745df") || t("g_6745df") || "\uD68C\uC6D0" : canonicalInstructor,
          branchId: log.branchId,
          classTime: canonicalClassName === (t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || "\uC790\uC728\uC218\uB828") ? '' : classTime,
          count: 0,
          deniedCount: 0,
          memberNames: []
        };
  ...
  const handleClassClick = cls => {
    const key = cls.className === (t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || "\uC790\uC728\uC218\uB828") ? `${cls.className}-${cls.branchId}` : `${cls.className}-${cls.instructor}-${cls.branchId}-${cls.classTime || 'no-time'}`;
      ...
      gap: '24px'
        ...
        color: 'var(--text-secondary)'
          ...
          margin: '0 auto 12px'
            ...
            {/* ─── Class Summary Cards ─── */}
            {!loadingHistorical && classCards.length > 0 && <CollapsibleCard id="logs-class-summary" title={`📊 ${isToday ? t("g_e1e8a7") || t("g_e1e8a7") || t("g_e1e8a7") || t("g_e1e8a7") || t("g_e1e8a7") || "\uC624\uB298" : formatDisplayDate(selectedDate)} 수업별 출석 요약`} titleExtra={`${classCards.length}개 수업`} defaultOpen={false}>
                    <div style={{
          display: 'grid',
            ...
            return <React.Fragment key={key}>
                ...
                boxShadow: isSelected ? '0 0 15px rgba(var(--primary-rgb), 0.2)' : 'none'
                  ...
                  gap: '4px'
                    ...
                    fontWeight: 'bold',
                    marginLeft: '6px'
                  }}>{t("g_886f0f") || t("g_886f0f") || t("g_886f0f") || t("g_886f0f") || t("g_886f0f") || "\u26D4 \uAC70\uBD80"}{cls.deniedCount}{t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || "\uBA85"}</span>}
                                    </div>
        ...
        color: 'var(--text-secondary)'
          ...
          marginTop: '10px'
            ...
            const filteredLogs = (selectedClassKey ? activeLogs.filter(l => {
              ...
              const classTime = info?.startTime || '00:00';
              const canonicalClassName = info?.className || l.className || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || t("g_8209e5") || "\uC77C\uBC18";
              const canonicalInstructor = info?.instructor || l.instructor || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || "\uC120\uC0DD\uB2D8";
              const logKey = canonicalClassName === (t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || t("g_2b3da3") || "\uC790\uC728\uC218\uB828") ? `${canonicalClassName}-${l.branchId}` : `${canonicalClassName}-${canonicalInstructor}-${l.branchId}-${classTime}`;
