...
const BookingsTab = ({
  ...
  const handleCancelBooking = async booking => {
    ...
    try {
      ...
      alert(t("g_cab5b0") || t("g_cab5b0") || t("g_cab5b0") || t("g_cab5b0") || t("g_cab5b0") || "\uC608\uC57D\uC774 \uCDE8\uC18C\uB418\uC5C8\uC2B5\uB2C8\uB2E4.");
      // 실시간 구독이므로 별도 새로고침 불필요
    } catch (e) {
      alert((t("g_8226c1") || t("g_8226c1") || t("g_8226c1") || t("g_8226c1") || t("g_8226c1") || "\uCDE8\uC18C \uC2E4\uD328: ") + e.message);
    }
  };
    ...
    return <div className="dashboard-card" style={{
      padding: '12px 16px'
        ...
        marginBottom: '8px'
          ...
          fontSize: '1rem',
          color: 'white'
        }}>{calYear}{t("g_e29d2c") || t("g_e29d2c") || t("g_e29d2c") || t("g_e29d2c") || t("g_e29d2c") || "\uB144"}{calMonth}{t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || "\uC6D4"}</span>
                    <button onClick={() => moveMonth(1)} style={dateBtnStyle}>▶</button>
                </div>
                <div style={{
        display: 'grid',
        ...
        marginTop: '6px'
                        ...
                        <button onClick={() => setSelectedDate(getTodayKST())} style={{
          background: 'none',
          border: 'none',
      ...
      marginBottom: expanded ? '12px' : 0
        ...
        textAlign: 'right'
          ...
          color: fillRate >= 100 ? '#ff4757' : 'var(--primary-gold)'
                        ...
                        {totalActive}/{capacity}{t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || "\uBA85"}</div>
                    {/* 미니 정원바 */}
                    <div style={{
          width: '60px',
          height: '4px',
          ...
          marginTop: '4px'
            ...
            transition: 'width 0.3s ease'
                    ...
                    {waitlisted.length > 0 && <div style={{
          fontSize: '0.65rem',
          color: '#f39c12',
          marginTop: '2px'
        }}>{t("g_65905a") || t("g_65905a") || t("g_65905a") || t("g_65905a") || t("g_65905a") || "\uB300\uAE30"}{waitlisted.length}{t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || t("g_7b3c6e") || "\uBA85"}</div>}
                </div>
            </div>

            {/* 펼침: 예약자 명단 */}
            {expanded && !isCancelled && <div style={{
      borderTop: '1px solid rgba(255,255,255,0.06)',
      paddingTop: '12px'
    }}>
                    {allBookings.length === 0 ? <div style={{
        fontSize: '0.8rem',
...
const BookingGroup = ({
  ...
  return <div>
      ...
      gap: '6px'
            ...
            {members.map(m => <div key={m.id} style={{
        padding: '4px 10px',
        borderRadius: '8px',
        ...
        gap: '4px'
                    ...
                    {m.memberName}
                    {m.waitlistPosition && <span style={{
          fontSize: '0.6rem',
          color: '#f39c12'
        }}>#{m.waitlistPosition}</span>}
                    {onCancel && <button onClick={e => {
          e.stopPropagation();
          onCancel(m);
        }} style={{
