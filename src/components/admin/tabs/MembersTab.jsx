      ...
      gap: '12px'
        ...
        border: '1px solid rgba(255,255,255,0.05)'
          ...
          color: 'var(--primary-theme-color)'
                        ...
                        {/* 2. 오늘 등록 (성장 지표) */}
                        <div className={`dashboard-card interactive ${filterType === 'registration' ? 'highlight' : ''}`} onClick={() => handleToggleFilter('registration')} style={{
        padding: '16px',
        ...
        if (riskCount > 0) {
          return <div className={`dashboard-card interactive ${filterType === 'churn' ? 'highlight' : ''}`} onClick={() => handleToggleFilter('churn')} style={{
            padding: '16px',
        ...
        return null;
                        ...
                        {/* 4. 안면 미등록 (기능 활성화) */}
                        {summary.bioMissingCount > 0 && <div className={`dashboard-card interactive ${filterType === 'bio_missing' ? 'highlight' : ''}`} onClick={() => handleToggleFilter('bio_missing')} style={{
        padding: '16px',
