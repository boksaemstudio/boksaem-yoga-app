  ...
  const SectionHeader = ({
    ...
    transition: 'all 0.2s'
      ...
      gap: '10px'
        ...
        color: '#71717a',
        fontWeight: '600'
      }}>{count}{t("g_a3a79a") || t("g_a3a79a") || t("g_a3a79a") || t("g_a3a79a") || t("g_a3a79a") || "\uAC1C \uADDC\uCE59"}</span>
            </div>
  ...
  return <div style={{
    ...
    gap: '16px'
      ...
      paddingLeft: '4px'
                    ...
                    <RuleCard icon={<Clock size={20} weight="fill" color="#3b82f6" />} title={t('TBD: 시작일 미확정 등록')} description={t("g_b39980") || t("g_b39980") || t("g_b39980") || t("g_b39980") || t("g_b39980") || "\uD68C\uC6D0 \uB4F1\uB85D \uC2DC \uC2DC\uC791\uC77C\uC744 \"TBD(\uBBF8\uC815)\"\uB85C \uC124\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC774 \uD68C\uC6D0\uC774 \uCC98\uC74C \uCD9C\uC11D\uD558\uB294 \uB0A0\uC774 \uC790\uB3D9\uC73C\uB85C \uC2DC\uC791\uC77C\uC774 \uB418\uACE0, \uC218\uAC15 \uAE30\uAC04\uC5D0 \uB530\uB77C \uC885\uB8CC\uC77C\uC774 \uC790\uB3D9 \uACC4\uC0B0\uB429\uB2C8\uB2E4."} badge={t('첫 출석 시 자동 확정')} tip={t('예: 3개월 수강권을 TBD로 등록 → 4월 1일 첫 출석 → 시작일 4/1, 종료일 6/30 자동 설정')} />
                    <RuleCard icon={<Clock size={20} weight="fill" color="#f59e0b" />} title={t('홀딩 (수강 일시정지)')} description={`회원의 수강권을 일시정지할 수 있습니다. 홀딩 중에 출석하면 자동으로 해제되며, 실제 정지한 일수만큼 종료일이 자동 연장됩니다.${holdRules.length > 0 ? ` 현재 설정된 홀딩 규칙: ${holdRules.map(r => `${r.durationMonths}개월권 → 최대 ${r.maxCount}회, ${r.maxWeeks}주`).join(' | ')}` : ''}`} badge={holdRules.length > 0 ? `${holdRules.length}개 규칙 설정됨` : t("g_bfa691") || t("g_bfa691") || t("g_bfa691") || t("g_bfa691") || t("g_bfa691") || "\uBBF8\uC124\uC815"} tip={t('예: 7일 홀딩 후 출석 → 종료일이 7일 뒤로 자동 연장')} />
                    ...
                    <RuleCard icon={<Users size={20} weight="fill" color="#71717a" />} title={t('잠든 회원 자동 분류')} description={`잔여 횟수가 있지만 일정 기간 출석하지 않은 회원은 '잠든 회원'으로 자동 분류됩니다. 대시보드에서 이 회원들을 한 눈에 확인하고 관리할 수 있습니다.`} badge={`${policies.DORMANT_THRESHOLD_DAYS || 14}일 미출석`} />
                    <RuleCard icon={<Bell size={20} weight="fill" color="#f43f5e" />} title={t('만료 임박 알림')} description={`종료일이 가까워진 회원을 미리 파악할 수 있습니다. 대시보드에 만료 임박 배지가 표시되며, 자동 알림을 보낼 수 있습니다.`} badge={`종료 ${policies.EXPIRING_THRESHOLD_DAYS || 7}일 전부터`} />
                </div>}
      ...
      paddingLeft: '4px'
        ...
        gap: '8px'
                    ...
                    <RuleCard icon={<Users size={20} weight="fill" color="#10b981" />} title={t('정원 관리 & 대기열')} description={`수업당 정원은 기본 ${bookingRules.defaultCapacity || 15}명입니다. 정원이 차면 ${bookingRules.enableWaitlist !== false ? t("g_752399") || t("g_752399") || t("g_752399") || t("g_752399") || t("g_752399") || "\uC790\uB3D9\uC73C\uB85C \uB300\uAE30\uC5F4\uC5D0 \uB4F1\uB85D\uB418\uBA70, \uB204\uAD70\uAC00 \uCDE8\uC18C\uD558\uBA74 \uB300\uAE30 1\uBC88\uC9F8 \uD68C\uC6D0\uC774 \uC790\uB3D9\uC73C\uB85C \uC608\uC57D \uD655\uC815\uB418\uACE0 \uD478\uC2DC \uC54C\uB9BC\uC744 \uBC1B\uC2B5\uB2C8\uB2E4." : t("g_53c481") || t("g_53c481") || t("g_53c481") || t("g_53c481") || t("g_53c481") || "\uC608\uC57D\uC774 \uAC70\uBD80\uB429\uB2C8\uB2E4 (\uB300\uAE30\uC5F4 \uBE44\uD65C\uC131\uD654)."}`} badge={`정원 ${bookingRules.defaultCapacity || 15}명`} tip={bookingRules.enableWaitlist !== false ? t("g_87ff7b") || t("g_87ff7b") || t("g_87ff7b") || t("g_87ff7b") || t("g_87ff7b") || "\uB300\uAE30\uC5F4 \uD65C\uC131\uD654 \uC0C1\uD0DC: \uCDE8\uC18C \uBC1C\uC0DD \uC2DC \uC790\uB3D9 \uC2B9\uACA9 + \uC54C\uB9BC" : undefined} />
                    ...
                    <RuleCard icon={<Info size={20} weight="fill" color="#8b5cf6" />} title={t('크레딧 정책 모드')} description={creditRules.mode === 'weekly' ? `주간 모드: 매주 ${[t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || t("g_95e431") || "\uC77C", t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || t("g_5b51dd") || "\uC6D4", t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || t("g_74d3f7") || "\uD654", t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || t("g_cae82d") || "\uC218", t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || t("g_d5f699") || "\uBAA9", t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || t("g_cef92d") || "\uAE08", t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || t("g_ccc0dc") || "\uD1A0"][creditRules.weeklyResetDay || 1]}요일에 주간 횟수가 리셋됩니다. 회원별 주간 수강 횟수 제한이 적용됩니다.` : t("g_5fda3f") || t("g_5fda3f") || t("g_5fda3f") || t("g_5fda3f") || t("g_5fda3f") || "\uCD1D\uD69F\uC218 \uBAA8\uB4DC: \uB4F1\uB85D \uC2DC \uBD80\uC5EC\uB41C \uCD1D \uD69F\uC218\uC5D0\uC11C \uCD9C\uC11D/\uC608\uC57D\uB9C8\uB2E4 1\uD68C\uC529 \uCC28\uAC10\uB429\uB2C8\uB2E4. \uC8FC\uAC04 \uC81C\uD55C \uC5C6\uC774 \uC6D0\uD558\uB294 \uB9CC\uD07C \uC218\uAC15 \uAC00\uB2A5\uD569\uB2C8\uB2E4."} badge={creditRules.mode === 'weekly' ? t("g_4b4c79") || t("g_4b4c79") || t("g_4b4c79") || t("g_4b4c79") || t("g_4b4c79") || "\uC8FC\uAC04 \uB9AC\uC14B \uBAA8\uB4DC" : t("g_cb494f") || t("g_cb494f") || t("g_cb494f") || t("g_cb494f") || t("g_cb494f") || "\uCD1D\uD69F\uC218 \uCC28\uAC10 \uBAA8\uB4DC"} />
                </div>}
