  ...
  return <div style={{
    ...
    gap: '16px'
      ...
      paddingLeft: '4px'
                    ...
                    <RuleCard icon={<Clock size={20} weight="fill" color="#3b82f6" />} title={t('TBD: 시작일 미확정 등록')} description={t("g_b39980") || "\uD68C\uC6D0 \uB4F1\uB85D \uC2DC \uC2DC\uC791\uC77C\uC744 \"TBD(\uBBF8\uC815)\"\uB85C \uC124\uC815\uD560 \uC218 \uC788\uC2B5\uB2C8\uB2E4. \uC774 \uD68C\uC6D0\uC774 \uCC98\uC74C \uCD9C\uC11D\uD558\uB294 \uB0A0\uC774 \uC790\uB3D9\uC73C\uB85C \uC2DC\uC791\uC77C\uC774 \uB418\uACE0, \uC218\uAC15 \uAE30\uAC04\uC5D0 \uB530\uB77C \uC885\uB8CC\uC77C\uC774 \uC790\uB3D9 \uACC4\uC0B0\uB429\uB2C8\uB2E4."} badge={t('첫 출석 시 자동 확정')} tip={t('예: 3개월 수강권을 TBD로 등록 → 4월 1일 첫 출석 → 시작일 4/1, 종료일 6/30 자동 설정')} />
                    <RuleCard icon={<Clock size={20} weight="fill" color="#f59e0b" />} title={t('홀딩 (수강 일시정지)')} description={`회원의 수강권을 일시정지할 수 있습니다. 홀딩 중에 출석하면 자동으로 해제되며, 실제 정지한 일수만큼 종료일이 자동 연장됩니다.${holdRules.length > 0 ? ` 현재 설정된 홀딩 규칙: ${holdRules.map(r => `${r.durationMonths}개월권 → 최대 ${r.maxCount}회, ${r.maxWeeks}주`).join(' | ')}` : ''}`} badge={holdRules.length > 0 ? `${holdRules.length}개 규칙 설정됨` : t("g_bfa691") || "\uBBF8\uC124\uC815"} tip={t('예: 7일 홀딩 후 출석 → 종료일이 7일 뒤로 자동 연장')} />
      ...
      paddingLeft: '4px'
        ...
        gap: '8px'
                    ...
                    <RuleCard icon={<Info size={20} weight="fill" color="#8b5cf6" />} title={t('크레딧 정책 모드')} description={creditRules.mode === 'weekly' ? `주간 모드: 매주 ${[t("g_95e431") || "\uC77C", t("g_5b51dd") || "\uC6D4", t("g_74d3f7") || "\uD654", t("g_cae82d") || "\uC218", t("g_d5f699") || "\uBAA9", t("g_cef92d") || "\uAE08", t("g_ccc0dc") || "\uD1A0"][creditRules.weeklyResetDay || 1]}요일에 주간 횟수가 리셋됩니다. 회원별 주간 수강 횟수 제한이 적용됩니다.` : t("g_5fda3f") || "\uCD1D\uD69F\uC218 \uBAA8\uB4DC: \uB4F1\uB85D \uC2DC \uBD80\uC5EC\uB41C \uCD1D \uD69F\uC218\uC5D0\uC11C \uCD9C\uC11D/\uC608\uC57D\uB9C8\uB2E4 1\uD68C\uC529 \uCC28\uAC10\uB429\uB2C8\uB2E4. \uC8FC\uAC04 \uC81C\uD55C \uC5C6\uC774 \uC6D0\uD558\uB294 \uB9CC\uD07C \uC218\uAC15 \uAC00\uB2A5\uD569\uB2C8\uB2E4."} badge={creditRules.mode === 'weekly' ? t("g_4b4c79") || "\uC8FC\uAC04 \uB9AC\uC14B \uBAA8\uB4DC" : t("g_cb494f") || "\uCD1D\uD69F\uC218 \uCC28\uAC10 \uBAA8\uB4DC"} />
                </div>}
