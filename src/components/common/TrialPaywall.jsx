...
const TrialPaywall = ({
    ...
    return <div style={{
      ...
      textAlign: 'center'
        ...
        boxShadow: '0 25px 50px rgba(0,0,0,0.5)'
          ...
          marginBottom: '12px',
          color: '#EF4444'
        }}>{t("g_78ebd4") || t("g_78ebd4") || t("g_78ebd4") || t("g_78ebd4") || t("g_78ebd4") || "\uBB34\uB8CC \uCCB4\uD5D8\uC774 \uC885\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4"}</h2>
                    <p style={{
          color: '#94a3b8',
          fontSize: '1rem',
          lineHeight: '1.6',
          marginBottom: '32px'
                        ...
                        {trialInfo.name || t("g_e54edb") || t("g_e54edb") || t("g_e54edb") || t("g_e54edb") || t("g_e54edb") || "\uC2A4\uD29C\uB514\uC624"}{t("g_a5feeb") || t("g_a5feeb") || t("g_a5feeb") || t("g_a5feeb") || t("g_a5feeb") || "\uC758 2\uAC1C\uC6D4 \uBB34\uB8CC \uCCB4\uD5D8 \uAE30\uAC04\uC774 \uB9CC\uB8CC\uB418\uC5C8\uC2B5\uB2C8\uB2E4."}<br />{t("g_40b83d") || t("g_40b83d") || t("g_40b83d") || t("g_40b83d") || t("g_40b83d") || "\uC5F0\uAC04 $69 (\uC57D 10\uB9CC\uC6D0) \uC73C\uB85C \uBAA8\uB4E0 \uAE30\uB2A5\uC744 \uACC4\uC18D \uC0AC\uC6A9\uD558\uC138\uC694."}</p>
          ...
          border: '1px solid rgba(255,255,255,0.1)'
            ...
            color: '#94a3b8',
            marginBottom: '8px'
          }}>{t("g_6850eb") || t("g_6850eb") || t("g_6850eb") || t("g_6850eb") || t("g_6850eb") || "\uD83C\uDDF0\uD83C\uDDF7 \uAD6D\uB0B4 \uACC4\uC88C\uC774\uCCB4 (100,000\uC6D0)"}</div>
                        <div style={{
            display: 'flex',
            ...
            borderRadius: '8px'
              ...
              color: '#fff',
              letterSpacing: '0.5px'
            }}>{t("g_447d9f") || t("g_447d9f") || t("g_447d9f") || t("g_447d9f") || t("g_447d9f") || "MG\uC0C8\uB9C8\uC744 9003-2623-9687-7"}<div style={{
                fontSize: '0.8rem',
                color: '#94a3b8',
                marginTop: '4px',
                fontWeight: 'normal'
              }}>{t("g_c3220b") || t("g_c3220b") || t("g_c3220b") || t("g_c3220b") || t("g_c3220b") || "\uC608\uAE08\uC8FC: \uC1A1\uB300\uBBFC"}</div>
                            </div>
                            <button onClick={() => {
              navigator.clipboard.writeText('9003262396877');
              alert(t("g_59a092") || t("g_59a092") || t("g_59a092") || t("g_59a092") || t("g_59a092") || "\uACC4\uC88C\uBC88\uD638\uAC00 \uBCF5\uC0AC\uB418\uC5C8\uC2B5\uB2C8\uB2E4.");
            }} style={{
              ...
              cursor: 'pointer',
              fontWeight: 'bold'
            }}>{t("g_6acf7a") || t("g_6acf7a") || t("g_6acf7a") || t("g_6acf7a") || t("g_6acf7a") || "\uBCF5\uC0AC"}</button>
                        </div>
                        <div style={{
            fontSize: '0.8rem',
            color: '#64748b',
            marginTop: '12px'
          }}>{t("g_fa7544") || t("g_fa7544") || t("g_fa7544") || t("g_fa7544") || t("g_fa7544") || "* \uC785\uAE08 \uD6C4"}<strong style={{
              color: '#94a3b8'
            }}>motionpt@gmail.com</strong>{t("g_b5dc5f") || t("g_b5dc5f") || t("g_b5dc5f") || t("g_b5dc5f") || t("g_b5dc5f") || "(\uB610\uB294 \uB3C4\uC785 \uBB38\uC758\uCC98)\uB85C \uC54C\uB824\uC8FC\uC2DC\uBA74 \uC989\uC2DC \uC11C\uBE44\uC2A4\uAC00 \uC5F0\uC7A5\uB429\uB2C8\uB2E4."}</div>
                    </div>
          ...
          width: '100%'
        }}>{t("g_a43eb5") || t("g_a43eb5") || t("g_a43eb5") || t("g_a43eb5") || t("g_a43eb5") || "\uD83C\uDF0D \uD574\uC678 \uACB0\uC81C: PayPal ($69)"}</a>
                </div>
            </div>;
  }
  ...
  return <>
      ...
      flexWrap: 'wrap'
                    ...
                    <span>{t("g_ee34df") || t("g_ee34df") || t("g_ee34df") || t("g_ee34df") || t("g_ee34df") || "\u23F0 \uBB34\uB8CC \uCCB4\uD5D8 D-"}{daysLeft}{t("g_c8540c") || t("g_c8540c") || t("g_c8540c") || t("g_c8540c") || t("g_c8540c") || "| \uC5F0\uAC04 $69\uB85C \uC5F0\uC7A5\uD558\uC138\uC694"}</span>
                    <a href={PAYPAL_PAYMENT_LINK} target="_blank" rel="noopener noreferrer" style={{
        padding: '6px 16px',
        background: 'rgba(0,0,0,0.3)',
        color: '#fff',
      ...
      }}>{t("g_3d82d9") || t("g_3d82d9") || t("g_3d82d9") || t("g_3d82d9") || t("g_3d82d9") || "\uD83D\uDCB3 \uD398\uC774\uD314 \uC5F0\uC7A5"}</a>
                </div>}
            {children}
        </>;
};
