...
const KakaoFloatingButton = () => {
  ...
  const texts = {
    ko: {
      tooltip: t("g_75caa9") || "\uAD81\uAE08\uD55C \uC810\uC774 \uC788\uC73C\uC2E0\uAC00\uC694?",
      title: t("g_4f1a01") || "\uBB38\uC758\uD558\uAE30",
      emailPh: t("g_6b90a5") || "\uB2F5\uBCC0 \uBC1B\uC73C\uC2E4 \uC774\uBA54\uC77C",
      msgPh: t("g_1757a2") || "\uAD81\uAE08\uD55C \uC810\uC744 \uC801\uC5B4\uC8FC\uC138\uC694",
      send: t("g_274cb0") || "\uBCF4\uB0B4\uAE30",
      sent: t("g_6b044e") || "\uC811\uC218\uB418\uC5C8\uC2B5\uB2C8\uB2E4!",
      sentDesc: t("g_5ccc60") || "\uBE60\uB978 \uC2DC\uC77C \uB0B4\uC5D0 \uC774\uBA54\uC77C\uB85C \uB2F5\uBCC0 \uB4DC\uB9AC\uACA0\uC2B5\uB2C8\uB2E4."
    },
    ja: {
      tooltip: '\u304a\u554f\u3044\u5408\u308f\u305b',
      title: '\u304a\u554f\u3044\u5408\u308f\u305b',
      emailPh: '\u3054\u8fd4\u4fe1\u5148\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9',
      msgPh: '\u3054\u8cea\u554f\u30fb\u3054\u8981\u671b\u3092\u304a\u66f8\u304d\u304f\u3060\u3055\u3044',
      send: '\u9001\u4fe1',
      sent: '\u9001\u4fe1\u3044\u305f\u3057\u307e\u3057\u305f\uff01',
      sentDesc: '\u30e1\u30fc\u30eb\u306b\u3066\u3054\u8fd4\u4fe1\u3055\u305b\u3066\u3044\u305f\u3060\u304d\u307e\u3059\u3002'
    },
    ru: {
      tooltip: '\u041d\u0443\u0436\u043d\u0430 \u043f\u043e\u043c\u043e\u0449\u044c?',
      title: '\u041d\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u043d\u0430\u043c',
      emailPh: '\u0412\u0430\u0448 email \u0434\u043b\u044f \u043e\u0442\u0432\u0435\u0442\u0430',
      msgPh: '\u041e\u043f\u0438\u0448\u0438\u0442\u0435 \u0432\u0430\u0448 \u0432\u043e\u043f\u0440\u043e\u0441',
      send: '\u041e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c',
      sent: '\u041e\u0442\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u043e!',
      sentDesc: '\u041c\u044b \u043e\u0442\u0432\u0435\u0442\u0438\u043c \u043d\u0430 \u0432\u0430\u0448 email.'
    },
    es: {
      tooltip: '\u00bfNecesitas ayuda?',
      title: 'Cont\u00e1ctanos',
      emailPh: 'Tu email para respuesta',
      msgPh: '\u00bfEn qu\u00e9 podemos ayudarte?',
      send: 'Enviar',
      sent: '\u00a1Enviado!',
      sentDesc: 'Te responderemos por email.'
    },
    pt: {
      tooltip: 'Precisa de ajuda?',
      title: 'Fale Conosco',
      emailPh: 'Seu email para resposta',
      msgPh: 'Como podemos ajudar?',
      send: 'Enviar',
      sent: 'Enviado!',
      sentDesc: 'Responderemos por email em breve.'
    },
    fr: {
      ...
      send: 'Envoyer',
      sent: 'Envoy\u00e9\u00a0!',
      sentDesc: 'Nous vous r\u00e9pondrons par email.'
    },
    de: {
      tooltip: 'Hilfe ben\u00f6tigt?',
      title: 'Kontakt',
      emailPh: 'Ihre E-Mail f\u00fcr Antwort',
      msgPh: 'Wie k\u00f6nnen wir Ihnen helfen?',
      send: 'Senden',
      sent: 'Gesendet!',
      sentDesc: 'Wir antworten per E-Mail.'
    },
    zh: {
      tooltip: '\u9700\u8981\u5e2e\u52a9\uff1f',
      title: '\u8054\u7cfb\u6211\u4eec',
    ...
    default: {
      tooltip: 'Need help?',
      title: 'Contact Us',
      emailPh: 'Your email for reply',
      msgPh: 'How can we help you?',
      send: 'Send',
      sent: 'Message sent!',
      sentDesc: "We'll reply to your email shortly."
    }
  };
  const txt = texts[lang] || texts.default;
  ...
  if (isKorean) {
    return <a href="http://pf.kakao.com/_zDxiMX/chat" target="_blank" rel="noopener noreferrer" style={{
      position: 'fixed',
      bottom: '30px',
      right: '30px',
      width: '60px',
    ...
    }} onMouseEnter={e => e.currentTarget.style.transform = 'scale(1.1) translateY(-5px)'} onMouseLeave={e => e.currentTarget.style.transform = 'scale(1) translateY(0)'} title={t("g_1759ce") || "\uCE74\uCE74\uC624\uD1A1\uC73C\uB85C \uBB38\uC758\uD558\uAE30"}>
      ...
      animation: 'fadeInUp 0.3s ease'
        ...
        padding: '20px 0'
          ...
          gap: '8px'
                                ...
                                <EnvelopeSimple size={22} color="#6366f1" weight="duotone" /> {txt.title}
                            </h3>
          ...
          outline: 'none'
                            ...
                            <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder={t.msgPh} rows={3} style={{
          width: '100%',
          padding: '12px 14px',
          borderRadius: '12px',
          border: '1px solid rgba(255,255,255,0.1)',
          ...
          fontFamily: 'inherit'
                            ...
                            <button onClick={handleSend} disabled={sending || !email.trim() || !message.trim()} style={{
          width: '100%',
          padding: '14px',
          borderRadius: '12px',
          border: 'none',
