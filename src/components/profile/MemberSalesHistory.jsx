  ...
  return <div style={{
    marginBottom: '20px'
      ...
      border: '1px solid rgba(255,255,255,0.05)'
                    ...
                    <ClockCounterClockwise size={32} style={{
        marginBottom: '10px',
        opacity: 0.5
      }} />
                    <p style={{
          ...
          boxShadow: '0 4px 12px rgba(0,0,0,0.1)'
            ...
            alignItems: 'center'
              ...
              flexWrap: 'wrap'
                ...
                borderRadius: '6px',
                fontWeight: 'bold'
              }}>{t('currentlyUsing')}</span>}
                                        {isItemUpcoming && <span style={{
                fontSize: '0.7rem',
                ...
                borderRadius: '6px',
                fontWeight: 'bold'
              }}>{t('preRegistered')}</span>}
                                    </div>
                                    <span style={{
              color: '#10b981',
              fontWeight: 'bold',
              fontSize: '1.05rem'
            }}>{(item.amount || 0).toLocaleString()}{t('won')}</span>
                                </div>

                                {/* 기간 표시 */}
                                {item.startDate && item.endDate && <div style={{
            fontSize: '0.85rem',
            ...
            gap: '6px'
                                        ...
                                        <span style={{
              opacity: 0.8
            }}>📅</span> {item.startDate} ~ {item.endDate}
                                    </div>}
            ...
            fontSize: '0.8rem'
              ...
              color: 'rgba(255,255,255,0.4)'
                                        ...
                                        {new Date(item.timestamp || item.date).toLocaleDateString('ko-KR', {
                timeZone: 'Asia/Seoul'
              })} {t('paidOn')}
                                    </span>
                                </div>
