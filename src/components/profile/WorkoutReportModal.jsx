    ...
    fontFamily: '"Pretendard", sans-serif'
      ...
      position: 'relative'
        ...
        textAlign: 'center'
          ...
          color: 'white',
          margin: '0 0 5px 0'
        }}>{t('workoutReport') || t("g_c6f3dc") || "\uAC74\uAC15 \uB9AC\uD3EC\uD2B8"}</h2>
                    <p style={{
        ...
        padding: '30px 25px'
          ...
          gap: '15px'
            ...
            padding: '15px'
              ...
              color: 'white',
              marginTop: '5px'
            }}>{t('member_workout_avg_hr') || t("g_a38216") || "\uD3C9\uADE0 \uC2EC\uBC15\uC218"}</div>
                        </div>
                        <div style={{
            background: 'rgba(255,255,255,0.05)',
            borderRadius: '16px',
            padding: '15px'
              ...
              color: 'white',
              marginTop: '5px'
            }}>{t('member_workout_duration') || t("g_969659") || "\uC6B4\uB3D9 \uC2DC\uAC04"}</div>
                        </div>
                        <div style={{
            background: 'rgba(255,255,255,0.05)',
            borderRadius: '16px',
            ...
            gridColumn: '1 / -1'
              ...
              color: 'white',
              marginTop: '5px'
            }}>{t('member_workout_max_hr') || t("g_b9ffd3") || "\uCD5C\uACE0 \uC2EC\uBC15\uC218"}</div>
                        </div>
                    </div>
        ...
        cursor: 'pointer'
                    ...
                    {t('member_workout_close') || t("g_218e2a") || "\uB2EB\uAE30"}
                </button>
            </div>
        </div>;
};
