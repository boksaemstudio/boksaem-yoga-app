...
const TopBar = memo(({
  ...
  return <div className="checkin-top-bar" style={{
    ...
    position: 'relative'
            ...
            <div className="branch-selector" style={{
      flex: 1,
      display: 'flex',
      gap: '10px'
    }}>
      ...
      flexShrink: 0
        ...
        background: 'rgba(255,255,255,0.15)'
                ...
                {weather && <>
                        <div className="top-weather" style={{
          display: 'flex',
          alignItems: 'center',
          gap: '10px'
        }}>
          ...
          background: 'rgba(255,255,255,0.15)'
                        ...
                        <span className="weather-date" style={{
          fontSize: '1.1rem',
          ...
          lineHeight: 1
            ...
            <div className="top-actions-right" style={{
      flex: 1,
      display: 'flex',
      ...
      alignItems: 'center'
                ...
                <button className="instructor-btn" onClick={onInstructorClick} aria-label={t('kiosk_topbar_instructor_only') || t("g_7c4e80") || t("g_7c4e80") || t("g_7c4e80") || t("g_7c4e80") || t("g_7c4e80") || "\uC120\uC0DD\uB2D8 \uC804\uC6A9"} style={{
        ...
        transition: 'none'
                    ...
                    {t('kiosk_topbar_instructor') || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || t("g_9564f6") || "\uC120\uC0DD\uB2D8"}
                </button>


                <button className="fullscreen-btn" onClick={toggleFullscreen} aria-label={isFullscreen ? t('kiosk_topbar_fullscreen_exit') || t("g_7a0d27") || t("g_7a0d27") || t("g_7a0d27") || t("g_7a0d27") || t("g_7a0d27") || "\uC804\uCCB4\uD654\uBA74 \uC885\uB8CC" : t('kiosk_topbar_fullscreen_enter') || t("g_c5835b") || t("g_c5835b") || t("g_c5835b") || t("g_c5835b") || t("g_c5835b") || "\uC804\uCCB4\uD654\uBA74 \uC2DC\uC791"} style={{
        background: 'rgba(255, 255, 255, 0.1)',
