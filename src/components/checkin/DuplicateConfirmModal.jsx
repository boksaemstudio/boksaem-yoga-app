      ...
      animation: 'scaleUp 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)'
        ...
        border: '1px dashed rgba(255,255,255,0.2)'
          ...
          marginBottom: '6px'
                        ...
                        {t('kiosk_dup_footer_text') || t("g_4bf474") || "\uC544\uBB34\uAC83\uB3C4 \uC548 \uB204\uB974\uBA74..."}
                    </p>
                    <div style={{
          fontSize: '1.2rem',
          fontWeight: 700,
          color: '#ffd700'
            ...
            fontSize: '1.5rem',
            color: '#fff'
          }}>{duplicateTimer}</span>{t('kiosk_dup_footer_timer_part1') || t("g_38f886") || "\uCD08 \uB4A4 \uC790\uB3D9\uC73C\uB85C "}<span style={{
            textDecoration: 'underline'
          }}>{t('kiosk_dup_footer_timer_highlight') || t("g_d03d76") || "\uCD9C\uC11D \uCC98\uB9AC"}</span>{t('kiosk_dup_footer_timer_part2') || t("g_5c5d7c") || "\uB429\uB2C8\uB2E4"}
                    </div>
                </div>
            </div>
        </div>;
