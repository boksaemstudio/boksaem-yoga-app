      ...
      width: '100%'
        ...
        zIndex: 20
          ...
          alignItems: 'center'
            ...
            cursor: 'pointer'
              ...
              fontWeight: 600,
              color: 'white'
            }}>{config.AI_CONFIG?.NAME || 'AI'} {t('med_chat_ai_subtitle') || t("g_bb666f") || t("g_bb666f") || t("g_bb666f") || t("g_bb666f") || t("g_bb666f") || "(\uB9C8\uC74C \uCC59\uAE40\uC774)"}</span>
                            <div style={{
              display: 'flex',
              alignItems: 'center',
              gap: '4px'
                ...
                color: 'rgba(255,255,255,0.6)'
                                    ...
                                    {isAnalyzing ? <span className="blinking-text">{t('med_chat_analyzing') || t("g_772a49") || t("g_772a49") || t("g_772a49") || t("g_772a49") || t("g_772a49") || "\uBD84\uC11D \uC911..."}</span> : isAILoading ? t('med_chat_thinking') || t("g_d6b1c2") || t("g_d6b1c2") || t("g_d6b1c2") || t("g_d6b1c2") || t("g_d6b1c2") || "\uC0DD\uAC01\uD558\uB294 \uC911..." : t('med_chat_voice_on') || t("g_a72608") || t("g_a72608") || t("g_a72608") || t("g_a72608") || t("g_a72608") || "\uC74C\uC131 \uB300\uD654 \uC911"}
                                </span>
                            </div>
                        </div>
                    </div>

                    {!isAnalyzing && <button onClick={() => finishAnalysis(true)} style={{
          padding: '6px 12px',
          borderRadius: '20px',
          ...
          cursor: 'pointer'
                            ...
                            {t('med_chat_btn_start_immediate') || t("g_755138") || t("g_755138") || t("g_755138") || t("g_755138") || t("g_755138") || "\uBC14\uB85C \uC2DC\uC791"}
                        </button>}
                </div>
        ...
        gap: '20px'
            ...
            gap: '8px'
              ...
              gap: '6px'
                ...
                textAlign: isMe ? 'right' : 'left'
                    ...
                    {currentAIChat && !isAILoading && <div style={{
          display: 'flex',
          ...
          gap: '8px'
            ...
            }}><TypewriterText text={currentAIChat.message || currentAIChat.question || t('med_chat_default_greeting') || t("g_6c87b3") || t("g_6c87b3") || t("g_6c87b3") || t("g_6c87b3") || t("g_6c87b3") || "\uC624\uB298 \uD558\uB8E8\uB294 \uC5B4\uB5A0\uC168\uB098\uC694?"} speed={40} /></div>
                                <span style={{
              fontSize: '0.7rem',
              color: 'rgba(255,255,255,0.4)',
              marginBottom: '2px'
                ...
                minute: '2-digit'
                    ...
                    {isAILoading && <div style={{
          alignSelf: 'center',
          marginTop: '10px'
        }}>
                            <AILoadingIndicator compact={true} message={chatHistory.length === 0 ? t('med_chat_ai_listening', {
            name: config.AI_CONFIG?.NAME || 'AI'
          }) || `AI ${config.AI_CONFIG?.NAME || 'AI'}가 당신의 마음을 듣고 있어요...` : null} />
                        </div>}
          ...
          width: '100%'
                ...
                <div style={{
        background: config.THEME?.SURFACE || '#1a1a1d',
        ...
        zIndex: 20
                    ...
                    {!isAILoading && currentAIChat?.isFinalAnalysis && <div style={{
          display: 'flex',
          flexDirection: 'column',
          gap: '10px',
          animation: 'fadeIn 0.5s ease'
            ...
            boxShadow: '0 10px 20px rgba(var(--primary-rgb), 0.3)'
                                ...
                                🧘 {t('med_chat_btn_start') || t("g_747d3d") || t("g_747d3d") || t("g_747d3d") || t("g_747d3d") || t("g_747d3d") || "\uBA85\uC0C1 \uC2DC\uC791\uD558\uAE30"}
                            </button>
                            <p style={{
            textAlign: 'center',
            fontSize: '0.8rem',
            color: 'rgba(255,255,255,0.4)'
          }}>{t('med_chat_prepared_desc') || t("g_ff9f7e") || t("g_ff9f7e") || t("g_ff9f7e") || t("g_ff9f7e") || t("g_ff9f7e") || "\uB2F9\uC2E0\uC5D0\uAC8C \uB9DE\uB294 \uBA85\uC0C1\uC744 \uC900\uBE44\uD588\uC5B4\uC694"}</p>
                        </div>}
          ...
          justifyContent: 'flex-start'
                            ...
                            {currentAIChat.options.map((opt, i) => <button key={i} onClick={() => {
            stopAllAudio();
            ...
            backdropFilter: 'blur(5px)'
                    ...
                    {!currentAIChat?.isFinalAnalysis && !currentAIChat?.isTransition && !isAnalyzing && <form onSubmit={e => {
          try {
          ...
          border: '1px solid rgba(255,255,255,0.1)'
                            ...
                            <input type="text" value={manualInput} onChange={e => setManualInput(e.target.value)} disabled={isAILoading} autoFocus placeholder={isAILoading ? t('med_chat_waiting_reply') || t("g_550dea") || t("g_550dea") || t("g_550dea") || t("g_550dea") || t("g_550dea") || "\uB2F5\uBCC0\uC744 \uAE30\uB2E4\uB9AC\uB294 \uC911..." : t('med_chat_input_placeholder') || t("g_77c0c8") || t("g_77c0c8") || t("g_77c0c8") || t("g_77c0c8") || t("g_77c0c8") || "\uC9C1\uC811 \uC785\uB825\uD558\uAE30..."} style={{
            flex: 1,
            ...
            justifyContent: 'center',
            cursor: 'pointer'
          }}><ArrowUp size={24} color="currentColor" /></button>
                        </form>}
                </div>
            </div>
        </div>;
