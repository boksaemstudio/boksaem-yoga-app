  ...
  return <div style={{
    ...
    paddingTop: '60px'
      ...
      gap: '16px'
                ...
                {chatHistory.map((chat, idx) => <div key={idx} style={{
      ...
      zIndex: 20
        ...
        justifyContent: 'flex-start'
          ...
          backdropFilter: 'blur(5px)'
                ...
                {/* 입력창 (마이크/텍스트) */}
                {!currentAIChat?.isFinalAnalysis && !currentAIChat?.isTransition && !isAnalyzing && <form onSubmit={handleManualSubmit} style={{
        display: 'flex',
        gap: '10px',
        alignItems: 'stretch',
        height: '52px'
          ...
          alignItems: 'center'
            ...
            fontSize: '0.95rem'
                            ...
                            {isAILoading && <LockKey size={18} color="rgba(255,255,255,0.3)" style={{
            position: 'absolute',
            right: '15px'
          }} />}
                        </div>
