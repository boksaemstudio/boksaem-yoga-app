...
## 0. 글로벌 SEO & 마케팅 헬스체크 (자동화)
// turbo
```bash
node scripts/daily_global_healthcheck.cjs
```
- 12개국 랜딩 페이지 SEO 메타태그 전수 점검
- 사이트맵/robots.txt 무결성 검증
- 응답속도 모니터링
- 현지화 혼입 문제 자동 탐지
- 보고서 자동 생성: `reports/healthcheck_YYYY-MM-DD.md`
